...
* **Description:** Praze is a creator-centric, on-chain reward and membership platform that allows creators to build beautiful, customizable profiles, accept support in DOT, KSM, and test tokens, and offer gated content, downloadable files, and memberships. With a sleek, intuitive design and creator-first approach, Praze reimagines web3 creator monetization by embedding it natively into the Polkadot ecosystem using ink! smart contracts.
...
* **Practical Use Case:** Praze is one of the first full-featured creator monetization platforms built with ink!. It demonstrates ink!'s power to go beyond infrastructure and deliver end-user value in elegant applications.
...
* **Tech Stack:**
  ...
  * Backend (optional): Supabase for metadata and analytics

* **PoC / MVP:**

  * Working MVP at [prazed.xyz](https://prazed.xyz) (formerly dotme)
...
* **Vision**: Establish Dotme as Polkadot’s go-to creator monetization tool, driving adoption and transactions across the ecosystem and beyond.

## Additional Information

**How did you hear about the Bounty Program?** Polkadot Twitter and forum announcements
...
* **Work Done**: MVP built and live, with positive community feedback on X (@implabinash).
* **No Other Teams**: Solo project.
* **Other Funding**: No other funding applications submitted; this is Dotme’s first grant request.
